...
abstract class ThemePickerSharedAppModule {
    ...
    companion object {
        ...
        @Provides
        @Singleton
        fun provideFontRepository(fontManager: FontManager): FontRepository {
            return FontRepository(fontManager)
        }

        @Provides
        @Singleton
        fun provideFontInteractor(fontRepository: FontRepository): FontInteractor {
            return FontInteractor(fontRepository)
        }
    }
}